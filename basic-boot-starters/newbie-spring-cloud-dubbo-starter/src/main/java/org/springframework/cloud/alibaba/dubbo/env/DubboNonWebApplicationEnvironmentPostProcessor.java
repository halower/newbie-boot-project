...
public class DubboNonWebApplicationEnvironmentPostProcessor implements EnvironmentPostProcessor, Ordered {
    ...
    private static final String PROTOCOL_PROPERTY_NAME_PREFIX = "services.protocol";
    ...
    private static final String PROTOCOLS_PROPERTY_NAME_PREFIX = "services.protocols";
     ...
     * or "services.protcols.controller.port"
     *
     * @param environment
