...
public class BeanUtil {
    ...
    BeanUtil() {
        if (Dependency.hasDependency("org.apache.commons.beanutils.BeanUtilsBean")) {
            this.useCache = true;
     ...
     * @return 值列表
     */
    public static Map<String, Object> findValuesByRel(Object obj, Map<String, Method[]> relFieldAndMethod) throws
    ...
    public static Object getValue(Object obj, Method method) throws InvocationTargetException {
     ...
     * @return 对应的值
     */
    public static Object getValue(Object obj, String fieldName) throws NoSuchFieldException {
     ...
     * @param value  要设置的值
     */
    public static void setValue(Object obj, Method method, Object value) throws InvocationTargetException {
     ...
     * @param value     要设置的值
     */
    public static void setValue(Object obj, String fieldName, Object value) throws NoSuchFieldException {
        Map<String, Field> fields = getFields(obj.getClass());
        if (fields.containsKey(fieldName)) {
     ...
     * @return 执行结果
     */
    public static Object invoke(Object obj, Method method, Object... args) throws InvocationTargetException {
