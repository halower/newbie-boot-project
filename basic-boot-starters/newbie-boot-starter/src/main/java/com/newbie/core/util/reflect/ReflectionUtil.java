package com.newbie.core.util.reflect;

import com.newbie.core.util.base.ExceptionUtil;
import com.newbie.core.util.base.ObjectUtil;
import com.newbie.core.util.base.type.UncheckedException;
...
public class ReflectionUtil {
	...
	Map<String, Map<String, Field>> FILEDS = new WeakHashMap<>();
	 ...
	 * @return 字段信息
	 */
	public static Map<String, Field> getFields(Class<?> clazz, Boolean useCache) {
		Map<String, Field> fields = FIELDS.getOrDefault(clazz.getName(), new HashMap<>());
		if (!fields.isEmpty()) return fields;
		Arrays.stream(clazz.getDeclaredFields()).forEach(field -> fields.put(field.getName(), field));
		if (clazz.getSuperclass() != null && clazz.getSuperclass() != Object.class) {
			fields.putAll(getFields(clazz.getSuperclass(), useCache));
		}
		if (useCache) FIELDS.put(clazz.getName(), fields);
		return fields;
	}
