...
import com.newbie.core.util.collection.ListUtil;
...
/**
 * 尽量使用Common Lang StringUtil, 基本覆盖了所有类库的StringUtils
 * 
...
public class MoreStringUtil {
	 ...
	 * 
	 * copy from Commons Lang 3.5 StringUtil 并做优化
	 * 
	 ...
	 * 高性能的Split，针对char的分隔符号，比JDK String自带的高效.
	 * 
	 * copy from Commons Lang 3.5 StringUtil, 做如下优化:
	 * 
	 * 1. 最后不做数组转换，直接返回List.
	 * 
	 * 2. 可设定List初始大小.
