...
public class Knife4jAutoConfiguration {
    ...
    @ConditionalOnProperty(name = "knife4j.cors",havingValue = "true",matchIfMissing = true)
    ...
    public OpenApiExtensionResolver markdownResolver(Knife4jProperties knife4jProperties){
        ...
        setting.setEnableOpenApi(false);
        setting.setEnableFooter(false);
        setting.setEnableFooterCustom(true);
        setting.setFooterCustomContent("Copyright  2020-[同方赛威讯政法事业部](http://www.tfswx.com.cn/)");
